        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-2xl font-bold tracking-tight font-outfit uppercase text-white">{{ $settings['app_name'] ?? 'Gen' }}<span class="text-orange-400">{{ $settings['app_name_suffix'] ?? 'Tix' }}</span></span>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 rounded-full glass flex items-center justify-center hover:text-orange-400 transition">
