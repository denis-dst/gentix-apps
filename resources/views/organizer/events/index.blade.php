        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('organizer.events.create') }}" class="px-4 py-2 bg-orange-600 text-white rounded-xl font-bold hover:bg-orange-700 transition shadow-lg shadow-orange-200 flex items-center gap-2 text-sm">
                            ...
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('events.show', $event->slug) }}" target="_blank" class="p-2 text-slate-500 hover:text-blue-600 bg-slate-100 rounded-lg border border-slate-200 transition shadow-sm">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                        </a>
                                        <a href="{{ route('organizer.events.edit', $event) }}" class="p-2 text-slate-500 hover:text-purple-600 bg-slate-100 rounded-lg border border-slate-200 transition shadow-sm">
