<x-app-layout>
    ...
    <div class="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <!-- Welcome Hero -->
        <div class="relative overflow-hidden bg-gradient-to-br from-orange-500 to-amber-600 rounded-3xl p-6 md:p-12 text-white shadow-xl shadow-orange-500/20">
            <div class="relative z-10 max-w-2xl">
                ...
                <p class="text-sm md:text-lg text-white/90 font-medium mb-6 md:mb-10 leading-relaxed max-w-md">
            ...
            <div class="absolute top-1/2 right-12 -translate-y-1/2 opacity-10 hidden lg:block">
                <svg class="w-64 h-64" fill="currentColor" viewBox="0 0 24 24"><path d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" /></svg>
            </div>
        </div>
