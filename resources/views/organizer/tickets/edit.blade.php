            ...
            <div class="p-8 space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        @php($wristbandConfig = $category->layout_config ?? [])
                        <div class="pt-4 border-t border-gray-50 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="wristband_league_name" value="{{ old('wristband_league_name', $wristbandConfig['league_name'] ?? 'BRI Super League 2025-26') }}" class="w-full rounded-xl border-gray-200 focus:border-purple-500 focus:ring-purple-500 transition px-4 py-3">
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">League Logo</label>
                                    @if(!empty($wristbandConfig['league_logo']))
                                        <img src="{{ Storage::url($wristbandConfig['league_logo']) }}" class="mb-2 h-12 w-full object-contain rounded-xl bg-gray-50 border border-gray-100">
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if(!empty($wristbandConfig['home_club_logo']))
                                        <img src="{{ Storage::url($wristbandConfig['home_club_logo']) }}" class="mb-2 h-12 w-full object-contain rounded-xl bg-gray-50 border border-gray-100">
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if(!empty($wristbandConfig['away_club_logo']))
                                        <img src="{{ Storage::url($wristbandConfig['away_club_logo']) }}" class="mb-2 h-12 w-full object-contain rounded-xl bg-gray-50 border border-gray-100">
                                    @endif
                            ...
                            <div>
                                ...
                                @if(!empty($wristbandConfig['sponsor_logos']))
                                    <div class="mb-3 grid grid-cols-4 gap-2">
                                        @foreach($wristbandConfig['sponsor_logos'] as $sponsorLogo)
                                ...
                                <p class="mt-2 text-[10px] text-gray-500 italic">Upload baru akan mengganti semua logo sponsor yang sudah tersimpan.</p>
                            </div>
                        </div>
                    </div>
                </div>
