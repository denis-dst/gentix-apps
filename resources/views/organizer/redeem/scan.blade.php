<x-app-layout>
    ...
    <div class="h-full w-full flex flex-col bg-[#010409] text-white overflow-hidden font-sans" x-data="redeemScanner()">
        <!-- Header Bar -->
        <header class="h-auto min-h-[4.5rem] pt-safe-top sm:pt-0 flex items-center justify-between px-4 sm:px-6 bg-[#0d1117] border-b border-white/5 shrink-0 z-50">
            <div class="flex items-center gap-3 sm:gap-4 py-3 sm:py-0">
                <a href="{{ route('organizer.redeem.index') }}" class="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-white/5 hover:bg-white/10 rounded-xl transition text-slate-300">
