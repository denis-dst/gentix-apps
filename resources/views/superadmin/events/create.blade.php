<x-app-layout>
    ...
    <div class="bg-white rounded-sm border-t-4 border-purple-600 shadow-md overflow-hidden max-w-5xl mx-auto">
        <div class="px-6 py-4 border-b border-[#dee2e6] flex justify-between items-center bg-white">
            <h3 class="text-lg font-bold text-gray-800">Create New Event</h3>
        ...
        <div class="p-6">
            <form action="{{ route('superadmin.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-8 flex justify-end gap-3 border-t border-gray-100 pt-5">
                    <a href="{{ route('superadmin.events.index') }}" class="px-5 py-2.5 bg-slate-100 border border-slate-200 text-slate-700 font-bold rounded-lg hover:bg-slate-200 transition shadow-sm">Cancel</a>
