<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-black text-slate-800 font-outfit">Buat Invoice Baru</h2>
                <p class="text-sm text-slate-500">Terbitkan tagihan untuk Penyedia Event</p>
            </div>
        </div>

        <form id="invoice-form" method="POST" action="{{ route('superadmin.invoices.store') }}">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" placeholder="Contoh: Biaya Layanan Platform Bulan Juli 2026" required
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="3" placeholder="Deskripsi tagihan..."
                                      class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-orange-400 focus:border-transparent resize-none">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border-t border-slate-100 pt-4 space-y-2">
                        ...
                        <div class="flex justify-between items-center text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" name="tax_percent" id="tax-percent" value="{{ old('tax_percent', 0) }}"
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                    ...
                    <input id="notes_input" type="hidden" name="notes" value="{{ old('notes') }}">
            ...
            row.innerHTML = `
                ...
                <div class="col-span-4 md:col-span-2">
                    ...
                    <input type="number" name="items[${idx}][quantity]" value="${qty}" min="0.01" step="0.01" required
                           class="item-qty w-full border border-slate-200 bg-white rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-400 focus:border-transparent text-center">
                </div>
